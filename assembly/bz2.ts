...
function inline(target: undefined, context: ClassFieldDecoratorContext<typeof BZip2State, i16> & { name: "MTFA_SIZE"; private: false; static: true; }): void | ((this: typeof BZip2State, value: i16) => i16) {
