...
<h1>TypeScriptRS-client - May 18, 2004</h1>
...
How to use:
1. Run `npm run build` and then `npm run bundle` in the server, this copies all required files to `../TypeScriptRS-client/public`. Start client with `npm run prod`.
